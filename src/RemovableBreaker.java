...
public class RemovableBreaker extends Component{
    public RemovableBreaker(SwitchBoss sketch, int id, Coord loc, String name, int orientation, int normalstate, int currentstate) {
        super(sketch, id, loc, name, orientation, normalstate, currentstate);
    }
